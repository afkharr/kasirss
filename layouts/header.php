                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                ...
                                <div class="font-weight-bold">
                                    <div class="text-truncate">Hi boy
                                        udah punya pacar belum?.</div>
                                    <div class="small text-gray-500">1:39</div>
                                </div>
                            </a>
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <div class="dropdown-list-image mr-3">
                                ...
                                <div>
                                    <div class="text-truncate">belum
                                        kenapa tu?</div>
                                    <div class="small text-gray-500">1:40</div>
                                </div>
                            </a>
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <div class="dropdown-list-image mr-3">
                                ...
                                <div>
                                    <div class="text-truncate">kami kan
                                        badut</div>
                                    <div class="small text-gray-500">1:41</div>
                                </div>
                            </a>
